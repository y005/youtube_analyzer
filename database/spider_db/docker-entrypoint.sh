...
setting_sharding_db() {
  ...
  # 2. 2개의 데이터베이스 서버 설정
  mysql -uroot -p'samho101' -e "CREATE SERVER IF NOT EXISTS master_db1 FOREIGN DATA WRAPPER mysql OPTIONS(HOST '192.168.0.3',DATABASE 'project01',USER 'user',PASSWORD '1234',PORT 3306);"
  mysql -uroot -p'samho101' -e "CREATE SERVER IF NOT EXISTS master_db2 FOREIGN DATA WRAPPER mysql OPTIONS(HOST '192.168.0.4',DATABASE 'project01',USER 'user',PASSWORD '1234',PORT 3306);"
}
